...
import { countNoOfQuestionsByUser, countUpVotes } from '../controllers/rewards.js';
...
router.post('/count',countNoOfQuestionsByUser) 
router.post('/vote/:id/count',countUpVotes)   
